        ...
        <div class="content shadow">
            ...
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    <textarea name="isi_laporan" placeholder="Write Your Report Here" class="form-control" rows="4">{{ old('isi_laporan') }}</textarea>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h3 class="mt-3 text-center">Login First</h3>
                <p class="text-center">Please Login With Registered Account.</p>
                <form action="#" method="POST">
                    @csrf
                    <div class="form-group">
